...
2.1 File I/O
System data such as parcels and repair requests can be saved and loaded using file handling.

2.2 Inheritance
User is the superclass, and Student and Admin extend it to reuse common attributes.

2.3 Exception Handling
Custom exception (InvalidInputException) is used to handle invalid menu inputs.

2.4 Keyboard I/O
The Scanner class is used for user input in the console.

2.5 Collections
ArrayList is used to store parcels, repair requests, and announcements dynamically.

2.6 Parametric Polymorphism
The Manageable<T> interface uses Generics to support multiple data types.
